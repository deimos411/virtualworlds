...
class VirtualJoystick extends Screen {
  ...
  constructor() {
    ...
    this._leftThumbContainer = this.makeThumbArea('leftThumb', 2, 'white', null)
    ...
    this._leftPuck = this.makeThumbArea('leftPuck', 0, 'white', 'blue')
    ...
    this._rightPuck = this.makeThumbArea('rightPuck', 0, 'white', 'red')
  }
